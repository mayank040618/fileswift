...
export function Footer() {
    ...
    // Hide footer on workspace and its sub-routes
    if (pathname === '/workspace' || pathname?.startsWith('/workspace/')) {
        return null;
    }

    return (
        <footer className="bg-white border-t border-slate-200 dark:bg-slate-900 dark:border-white/[0.06] mt-[60px] pt-[70px] pb-[40px]">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="mt-4 text-sm text-slate-600 dark:text-slate-400 max-w-xs space-y-3">
                            <p>
                                Premium, secure, and fast AI-powered file tools.
                                Convert, compress, and analyze documents in seconds.
                            </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                            ...
                            <li><Link href="/tools/pdf-to-image" className="hover:text-blue-600 transition-colors">PDF to Image</Link></li>
                            <li><Link href="/tools/image-to-text" className="hover:text-blue-600 transition-colors">Image to Text</Link></li>
                ...
                <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 text-center text-sm text-slate-500">
                    &copy; {new Date().getFullYear()} FileSwift. AI-powered document tools. All rights reserved.
                </div>
            </div>
        </footer>
    );
