      ...
      faq: [
        {
          ...
          answer:
            "You can use FileSwift to compress PDFs for free. Simply upload your file, choose a compression level, and download the optimized version. No account is required.",
        },
        {
          question: "What is the best free PDF compressor?",
          answer:
            "FileSwift is a highly recommended free option because it balances high compression rates with document quality and guarantees privacy by deleting files after processing.",
        },
        {
          question: "Is it safe to compress sensitive PDFs online?",
          answer:
            "Yes. FileSwift uses SSL encryption for all transfers and permanently deletes your files from the server after one hour to ensure your data remains private.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "FileSwift uses smart compression to remove invisible metadata and optimize pixel density. This reduces file size significantly while keeping the image looking the same to the human eye.",
        },
        {
          question: "Can I compress multiple images at once?",
          answer:
            "Yes, FileSwift supports bulk image compression. You can upload multiple JPG or PNG files and process them simultaneously.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "You can use FileSwift to turn pictures into a PDF. Upload your JPG or PNG files, arrange them, and the tool will combine them into a single PDF document.",
        },
        {
          question: "Can I combine multiple JPGs into one PDF?",
          answer:
            "Yes. FileSwift allows you to upload multiple images and merge them into one continuous PDF file.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "Yes. FileSwift is a browser-based tool that converts PDF to Word online, so you do not need to install Microsoft Office or Adobe Acrobat.",
        },
        {
          question: "Is the converted Word doc editable?",
          answer:
            "Yes. The output file is a standard Microsoft Word document (.docx) that you can open and edit fully.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            'Use FileSwift to upload multiple PDFs and click "Merge". It binds them into a single file instantly and is completely free to use.',
        },
        {
          question: "Can I change the order of files?",
          answer:
            "Yes. Before merging, you can drag and drop the file thumbnails to arrange them in the exact order you want.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "Upload your file to FileSwift, choose the rotation angle, and click process. The tool saves the new orientation permanently so it opens correctly every time.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "FileSwift uses high-quality resampling algorithms to change image dimensions while preserving as much detail and sharpness as possible.",
        },
        {
          question: "Is there a free online image resizer?",
          answer:
            "Yes, FileSwift provides a free image resizer that allows you to change dimensions of unlimited images without watermarks.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "Yes. FileSwift's Bulk Image Resizer allows you to upload a batch of photos and apply the same size settings to all of them instantly.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "Upload your PDF to FileSwift, select JPG as the format, and convert. The tool will turn each page into a separate JPG image file.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "Simply upload your Word document to FileSwift. It will automatically convert the file to PDF format, which you can then download and share.",
        },
      ],
    },
    longDescription: `
...
`,
  ...
  // 12. Remove Background (AI)
  {
    ...
    description:
      "Remove image background instantly with AI. Get transparent PNG in seconds.",
    icon: "Eraser",
    color: "bg-rose-500",
      ...
      faq: [
        {
          ...
          answer:
            "Upload your image to FileSwift and our AI will automatically detect and remove the background. You get a transparent PNG file for free, no signup required.",
        },
        {
          question: "Can I remove background from product photos?",
          answer:
            "Yes! FileSwift works great for product photography. Upload your product image and get a clean, transparent background perfect for Amazon, eBay, or Shopify listings.",
        },
        {
          question: "What image formats are supported?",
          answer:
            "You can upload JPG, PNG, and WEBP images. The output is always a high-quality PNG with transparent background.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            'Upload your PDF to FileSwift, select "Split All Pages" option, and each page will be saved as a separate PDF file. Download them individually or as a ZIP.',
        },
        {
          question: "Can I extract specific pages from a PDF?",
          answer:
            "Yes! You can select specific pages (e.g., pages 2, 5, and 8) or ranges (e.g., pages 1-10) to extract into a new PDF file.",
        },
      ]
    },
    longDescription: `
...
FileSwift allows you to easily split a PDF file into multiple documents or extract specific pages. Whether you need to separate chapters of an eBook, pull a single invoice from a batch, or divide a report, this tool makes it entirely private.

### Extracting Specific Pages
Select exactly which pages you want. You can enter individual page numbers (e.g. 1, 4, 7) or specify ranges (e.g. 3-8) to instantly generate a new document containing only those pages.

### Split All Pages
Need every page as its own file? Choose to split the entire document, and FileSwift will process it locally, ensuring your data is never uploaded to an external server.
`
  },
  // 17. Protect PDF
  {
    id: 'protect-pdf',
    title: 'Protect PDF',
    description: 'Encrypt and password protect a PDF file.',
    icon: 'Lock',
    color: 'bg-indigo-500',
    slug: '/tools/protect-pdf',
    type: 'file',
    privacyMode: 'client',
    keywords: ['password protect pdf', 'encrypt pdf', 'lock pdf', 'secure pdf online', 'add password to pdf free', 'private pdf encryption'],
    content: {
      features: [
        '100% Private: Encryption happens entirely inside your browser.',
        'Strong Security: Uses standard PDF encryption to secure your document.',
        'Instant Locking: Protect your file instantly without server uploads.',
        'Free Tool: Lock as many PDFs as you need for free.'
      ],
      howTo: [
        'Upload your PDF document.',
        'Enter a strong password to lock the file.',
        'Click "Protect PDF".',
        'Download your encrypted PDF.'
      ],
      benefits: [
        'Prevent unauthorized access to sensitive documents.',
        'Secure financial statements or personal records.',
        'Ensure compliance when sharing confidential files via email.'
      ],
      faq: [
        {
          question: 'Can I recover a forgotten password?',
          answer: 'No. FileSwift encrypts the file locally and we do not store your passwords or files. If you forget it, the document cannot be unlocked.'
        },
        {
          question: 'Is my file safe?',
          answer: 'Yes. The protection happens entirely in your browser using local encryption. Your file is never uploaded to our servers.'
        }
      ]
    },
    longDescription: `
...
FileSwift allows you to easily encrypt your PDF documents with a password. This ensures that only authorized individuals can open and view the contents of the file.

### Secure Encryption
By using standard PDF encryption algorithms, the protection applied to your document is robust and recognized by all standard PDF viewers (like Adobe Acrobat, Apple Preview, and web browsers).

### Browser-Based Privacy
When securing sensitive documents like tax returns, legal contracts, or financial statements, privacy is paramount. FileSwift performs the encryption entirely on your device's memory. Your original file and your password are never sent to an external server.
`
  },
  // 18. Unlock PDF
  {
    ...
    type: 'file',
    privacyMode: 'server',
    keywords: ['remove password from pdf', 'unlock pdf', 'decrypt pdf', 'remove pdf security', 'pdf password remover online', 'private pdf unlock'],
    content: {
      features: [
        '100% Private: Decryption happens entirely inside your browser.',
        'Instant Unlocking: Remove passwords instantly without server delays.',
        'Universal Support: Works with most standard encrypted PDFs (requires the password).',
        'Free Tool: Unlock as many PDFs as you need for free.'
      ],
      howTo: [
      ...
      benefits: [
        'Remove passwords from documents you own for easier access.',
        'Prepare locked files for editing or merging.',
        'Stop entering a password every time you open a recurring document.'
      ],
      faq: [
        {
          question: 'Does this tool hack the password?',
          answer: 'No. You must know the current password to unlock the document. This tool simply removes the encryption so you don\'t have to enter the password in the future.'
        },
        {
          question: 'Is my unlocked file safe?',
          answer: 'Yes. The decryption process happens locally on your device. Your file and password are never uploaded.'
        }
      ]
    },
    longDescription: `
## Unlock a Password Protected PDF Online

FileSwift allows you to easily remove the password from an encrypted PDF document. If you have a document that you frequently access and find it tedious to repeatedly enter the password, this tool will create an unlocked copy for you.

### Know the Password
Please note that this is not a password-cracker. You must know the correct password to unlock the document. Once verified, the encryption is permanently removed from the newly saved file.

### Complete Client-Side Privacy
Decryption is handled entirely by your browser's local memory. Your password and the contents of the PDF are never transmitted to an external server, ensuring the highest level of privacy for your sensitive documents.
`
  },
  // 14. JPG to PNG
  {
      ...
      faq: [
        {
          ...
          answer:
            "PNG supports transparent backgrounds and lossless compression, making it better for logos, graphics, and images with text. JPGs lose quality each time they are edited.",
        },
        {
          question: "Is the conversion free?",
          answer:
            "Yes, FileSwift offers unlimited free JPG to PNG conversions with no watermarks or signup required.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "JPG files are much smaller than PNGs, making them faster to upload, share, and load on websites. Use JPG for photos where transparency is not needed.",
        },
        {
          question: "What happens to transparent areas?",
          answer:
            "Transparent areas in PNG files will be replaced with a white background when converted to JPG, since JPG does not support transparency.",
        },
      ],
    },
    longDescription: `
...
### Benefits of JPG
-   **Smaller Size**: Takes up less space on your device.
...
`,
  ...
  // 16. Watermark PDF
  {
    ...
    keywords: [
      ...
      "private pdf watermark",
    ],
    content: {
      features: [
        "100% Private: Watermarks are added directly inside your browser—no files are uploaded.",
        "Instant Rendering: Process documents instantly without server delays.",
        'Custom Text: Enter any text like "CONFIDENTIAL", "DRAFT", or your company name.',
        "Diagonal Placement: The text is intelligently positioned diagonally across all pages.",
        "Auto-Sizing: The watermark automatically scales based on the underlying page size.",
        "Professional Look: The watermark uses a subtle transparency to not obscure the text beneath it.",
      ],
      howTo: [
        "Upload your PDF document.",
      ...
      benefits: [
        "Protect your intellectual property from unauthorized distribution.",
        "Mark draft versions of documents clearly for your team.",
        "Brand your PDF reports before sending them to clients.",
      ],
      faq: [
        {
          question: "How do I add a watermark to my PDF without Adobe?",
          answer:
            "You can use FileSwift to easily stamp a text watermark on your PDF for free entirely from your browser.",
        },
        {
          question: "Is my document sent to a server?",
          answer:
            "No. The watermarking process runs 100% locally on your device for absolute privacy.",
        },
      ],
    },
    longDescription: `
...
FileSwift allows you to easily stamp your PDF documents with a custom text watermark. This is important for protecting intellectual property, branding shared documents, or marking a file's status such as "DRAFT" or "CONFIDENTIAL".

### Intelligent Auto-Sizing
No complex settings. You just type the text, and FileSwift automatically calculates the best font size, centers it, and angles it at 45 degrees to perfectly span across the document content without being obtrusive. 

### Privacy Guaranteed
Since businesses often need to watermark highly sensitive documents, FileSwift guarantees privacy by performing the entire process using your browser's local memory. The file is never uploaded to an external server.
`,
  },
  // 16. HEIC to JPG
  // 16. HEIC to JPG
  {
    ...
    description:
      "Convert iPhone HEIC photos to JPG format. Works on all devices.",
    icon: "Smartphone",
    color: "bg-blue-500",
    ...
    keywords: [
      ...
      "private heic to jpg",
      "instant iphone photo conversion",
    ],
    content: {
      features: [
      ...
      faq: [
        {
          ...
          answer:
            "HEIC (High Efficiency Image Container) is Apple's image format used on iPhones. It offers smaller file sizes than JPG but isn't supported on Windows and many websites.",
        },
        {
          question: "How do I convert HEIC to JPG on Windows?",
          answer:
            "Simply upload your HEIC file to FileSwift using any browser. We convert it to JPG instantly, which you can then download and open on Windows without any special software.",
        },
        {
          question: "Is the quality reduced?",
          answer:
            "FileSwift preserves the original quality when converting HEIC to JPG. The output file will look identical to the original.",
        },
      ],
    },
    longDescription: `
      ...
      faq: [
        {
          ...
          answer:
            "This tool works best for PDFs containing structured tables. Unstructured text or images will not convert well to spreadsheet format.",
        },
        {
          question: "Is the converted Excel editable?",
          answer:
            "Yes! The output is a standard .xlsx file that you can open and edit in Microsoft Excel, Google Sheets, or any spreadsheet software.",
        },
      ],
    },
    longDescription: `
...
### Best For
  ...
  // 21. YouTube Thumbnail Resizer (SEO Specialized)
  {
    ...
    description:
      "Resize any image to the perfect 1280x720 YouTube thumbnail size.",
    icon: "Video",
    color: "bg-red-600",
      ...
      faq: [
        {
          ...
          answer:
            "YouTube accepts JPG, PNG, and WEBP. We recommend PNG for maximum clarity.",
        },
      ],
    },
    longDescription: `
...
FileSwift helps creators optimize their videos by providing an instant 1280x720 resizer.Don't let a blurry or badly sized thumbnail lower your views.
  ...
  // 22. Bank Statement PDF Compressor
  {
    ...
    description:
      "Securely reduce the size of bank statements for loan and visa applications.",
    icon: "Lock",
    color: "bg-emerald-600",
    ...
    keywords: [
      ...
      "bank pdf reducer",
      "private bank statement compressor",
      "no upload bank statement tool",
    ],
    content: {
      features: [
      ...
      faq: [
        {
          ...
          answer:
            "No. FileSwift uses client-side processing for sensitive documents whenever possible, and we never store your data.",
        },
      ],
    },
    longDescription: `
...
FileSwift's specialized compressor ensures your sensitive financial documents are small enough for portal uploads while maintaining 100% legibility of every transaction.
  ...
  // 23. Resume Photo Resizer
  {
    ...
    description:
      "Resize your professional headshot for resumes and CV templates.",
    icon: "UserCircle",
    color: "bg-blue-400",
      ...
      faq: [
        {
          ...
          answer:
            "Many modern resumes use a 300x300 pixel square photo, while official CVs often use 3.5x4.5 cm.",
        },
      ],
    },
    longDescription: `
